                ...
                <div class="slides">
                    <div class="row py-5">
                        <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                            ...
                            <h1 class="display-4 mb-4"><span class="text-primary">Pet Boarding</span> & <span
                                    class="text-secondary">Care</span></h1>
                            <h5 class="text-muted mb-3">At PetZee, we are dedicated to providing comprehensive care for your
                                pets,
                                ensuring their well-being in a safe and loving environment.</h5>
                            <p class="mb-4">At PetZee, our pet boarding services provide a safe and comfortable environment where your pets can feel at home, even when you're away. We ensure each pet receives personalized attention, daily exercise, and socialization with other pets under the supervision of our trained staff. From cozy accommodations to regular feeding and playtime, we are dedicated to keeping your furry friends happy, healthy, and well-cared for during their stay with us.</p>

                            <ul class="list-inline">
                                <li>
                                    <h5><i class="fa fa-check-double text-secondary mr-3"></i>Spacious & Hygienic Facilities</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-check-double text-secondary mr-3"></i>Custom Feeding Plans</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-check-double text-secondary mr-3"></i>Regular Health Checks</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-check-double text-secondary mr-3"></i>Comfortable Sleeping Areas</h5>
                                </li>

                            </ul>
                            <a href="booking.php" class="btn btn-lg btn-primary mt-3 px-4">Book Now</a>
                        </div>
                        <div class="col-lg-5 pb-5 pb-lg-0 px-3 px-lg-5">
                            <div class="wrapper">
                                <div class="container1">
                                    <div class="img box-1" style="--image: url(https://r2.fivemanage.com/pub/zajhv3p9jf1o.jpg)">
                                    </div>
