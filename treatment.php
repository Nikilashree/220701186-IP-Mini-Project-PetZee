        ...
        <div class="slides">
            <div class="row py-5">
                <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                    ...
                    <h1 class="display-4 mb-4"><span class="text-primary">Pet Treatment</span> & <span class="text-secondary">Health Care</span></h1> 
                    <h5 class="text-muted mb-3">At PetZee, we prioritize your pet’s well-being with comprehensive health care services tailored to their specific needs.</h5> <p class="mb-4">Our treatment services focus on maintaining and improving the health of your pets. Whether it's routine check-ups, vaccinations, or specialized medical care, our qualified veterinarians provide compassionate and personalized attention. With state-of-the-art facilities and a caring environment, we ensure your pets receive the best possible care to lead a healthy and happy life.</p>
                ...
                <div class="col-lg-5 pb-5 pb-lg-0 px-3 px-lg-5">
                    <div class="wrapper">
                        <div class="container1">
                            <div class="img box-1" style="--image: url(https://r2.fivemanage.com/pub/9823kyozad9a.jpg)">
                            </div>
                            <div class="img box-2" style="--image: url(https://r2.fivemanage.com/pub/tine91qd77xi.png)">
                            </div>
                            <div class="img box-3" style="--image: url(https://r2.fivemanage.com/pub/uqig0fgh1ee7.jpg)">
                            </div>
                        </div>
                    </div>
                </div>
